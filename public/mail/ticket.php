...
<head>
    ...
    <title>Send Ticket Update</title>
    <style>
    ...
    <div class="main-content">
        <header class="header">
            <div class="header-content">
                <h1>Send Ticket Update</h1>
            </div>
        </header>

        <main class="content">
            <div class="mail-card">
                <h3>Send Ticket Update</h3>
                <form action="send_mail.php" method="POST" class="mail-form">
                    <input type="hidden" name="email_type" value="ticket">
                    <label for="ticket_email">Recipient Email:</label>
                    <input type="email" name="recipient_email" id="ticket_email" value="support_user@example.com" required>
                    <label for="ticket_id">Ticket ID:</label>
                    <input type="text" name="ticket_id" id="ticket_id" value="TICKET-XYZ" required>
                    <label for="ticket_status">Ticket Status:</label>
                    <input type="text" name="ticket_status" id="ticket_status" value="Resolved" required>
                    <label for="ticket_subject">Subject:</label>
                    <input type="text" name="subject" id="ticket_subject" value="Your Ticket Status Update" required>
