...
// The getDatabaseConnection() function remains in a common file
// to be included by all pages that need it.
...
if (isset($_GET['status'])) {
    if ($_GET['status'] == 'success') {
        $message = htmlspecialchars($_GET['msg'] ?? 'Email sent successfully!');
    } else {
        $error_message = htmlspecialchars($_GET['msg'] ?? 'Failed to send email.');
    }
}
?>
...
<head>
    ...
    <style>
        /* All the CSS from your original file remains here */
        :root {
    ...
    <div class="main-content">
        ...
        <main class="content">
            ...
            <div class="mail-actions">
                <div class="mail-card">
                    <h3>Client Mail</h3>
                    <p>Send project updates, reports, and other communications to clients.</p>
                    <a href="client.php" class="btn btn-primary">Send Client Mail</a>
                </div>
                
                <div class="mail-card">
                    <h3>Team Mail</h3>
                    <p>Communicate with your team members about weekly reports and internal updates.</p>
                    <a href="team.php" class="btn btn-primary">Send Team Mail</a>
                </div>
                
                <div class="mail-card">
                    <h3>Ticket Update</h3>
                    <p>Send a status update to a client regarding a support ticket.</p>
                    <a href="ticket.php" class="btn btn-primary">Send Ticket Update</a>
                </div>
                
                <div class="mail-card">
                    <h3>Promotional Mail</h3>
                    <p>Send marketing and promotional emails to potential clients.</p>
                    <a href="promotion.php" class="btn btn-primary">Send Promotional Mail</a>
                </div>
            </div>
